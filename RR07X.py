...
class REQ:
   ...
   def REQ_Cookie(self):
       ...
       try:
           ...
           Console().print(f"[•]{U2} {str(e).title()}") ; sleep(3.1) ; self.REQ_Cookie()
   ...
   def Publik(self, params, host, user, array, coki):
       try:
           ...
           for xyz in req['data']:
               ...
               Console().print(f'[•]{U2}Total Dump{N} -: {B2}{len(array)}{P2}',end='\r')
                ...
                for z in self.all_friends:
                    ...
                    if len(self.name) == 0 or len(self.name) > 100:
                        ...
                        if str(self.id_friends) in str(dump):
                            ...
                            Console().print(f'[•]{U2}Total Dump{N} -: {K2}{len(dump)}{P2}',end='\r')
        ...
        try:
            for xyc in range(int(total)):
                ...
                if data in dump:pass
                    ...
                    Console().print(f'[•]{U2}Total Dump{N} -: {H2}{len(dump)}.{len(data)}{P2}',end='\r')
